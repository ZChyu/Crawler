...
#    URL = "https://www.nyxdt.net/buy/?page="+str(page)
    URL = "http://www.eee.cn/search.jsp?province=370000&city=370200&district=&typeflag=&type=0&swType=0&zhuanti=0&key=&strFenyeFlag=1&strListCount=48571&maxPage=1620&repl="+str(page)
    print(URL)
    html = ''
    try:
...
#    print(html)
    ...
    res = []
    for i in range(30):
        divs = soup.find('body').find_all('div')[2].find_all('table')[17+3*i]
...
if __name__=='__main__':
    xianchenshu=10
    typess=sifany_util_math.trans_group(list(range(100,500)),xianchenshu)
